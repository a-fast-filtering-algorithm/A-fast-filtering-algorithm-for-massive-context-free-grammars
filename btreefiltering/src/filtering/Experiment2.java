...
public class Experiment2 {
	...
	private static void runExperiment3() throws IOException {
		...
		PrintWriter pw = new PrintWriter(new FileWriter(new File("full_tree/terminating_tree_stats_tmp.csv")));
		
		String header = "|g|,|t|,|p|,worst_case,|s|_worst,median,|s|_median";
		pw.println(header);
		
		File dir = new File("grammars/good_grammars");
	...
	private static void runExperiment2() throws IOException {
		...
		PrintWriter pw = new PrintWriter(new FileWriter(new File("full_tree/terminal_tree_filter_stats_tmp.csv")));
	...
	private static void runExperiment1() throws IOException {
		...
		PrintWriter pw = new PrintWriter(new FileWriter(new File("full_tree/basic_filter_stats_tmp.csv")));
