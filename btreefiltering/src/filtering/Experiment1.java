...
public class Experiment1 {
	...
	private static void runExperiment3() throws IOException {
		...
		PrintWriter pw = new PrintWriter(new FileWriter(new File("sparse_tree/terminating_tree_stats_tmp.csv")));
	...
	private static void runExperiment2() throws IOException {
		...
		PrintWriter pw = new PrintWriter(new FileWriter(new File("sparse_tree/terminal_tree_filter_stats_tmp.csv")));
		
		String header = "|g|,|t|,|p|,worst_case,|s|_worst,median,|s|_median,|tree|";
		pw.println(header);
	...
	private static void runExperiment1() throws IOException {
		...
		PrintWriter pw = new PrintWriter(new FileWriter(new File("sparse_tree/basic_filter_stats_tmp.csv")));
	...
	private static String run(Grammar g, boolean tree) {
		...
		return String.format("%d,%d,%d,%f,%f,%f,%f,%d", g_size, t_size, p_size, worstCase, worstSize,
				median, medianSize,g.treeSize);
	}
